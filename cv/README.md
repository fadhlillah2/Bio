...
| Need | Send this |
|---|---|
| Official full CV (LinkedIn mirror, 2 pages) | [`resume-v8.6.pdf`](resume-v8.6.pdf) |
| Job application / recruiter (1 page, ATS-keyworded) | [`resume-1pager-v1.6.pdf`](resume-1pager-v1.6.pdf) |
...
| File | What it is |
|---|---|
| `archive/resume-v8.5.txt` / `.pdf` | v8.5 — adds the FOX Asset — Infinity Wave contract entry (LinkedIn paste pending). Superseded by v8.6 (expert-advisor-mt-5 block rewritten from the live repo). |
...
```
resume:      v7.1 ──► v8.0 ──► v8.1 ──► v8.2 (curated 1-page) ──► v8.3 (full LinkedIn mirror, 2 pages) ──► v8.4 (+ expert-advisor-mt-5 block) ──► v8.5 (+ FOX Asset — Infinity Wave contract entry) ──► v8.6 (expert-advisor-mt-5 block rewritten from live repo state; LinkedIn paste pending for both)
1pager:      resume-1pager v1.0 ──► v1.1 ──► v1.2 ──► v1.3 ──► v1.4 (ATS keyword expansion) ──► v1.5 (+ FOX Asset entry, Freelance section trimmed) ──► v1.6 (recruiter/ATS edition, v8.2 lineage — parallel artifact, not a mirror; v1.6 = + expert-advisor-mt-5 PROJECTS line + MQL5 skill)
...
- **Artifact roles:** `resume-v8.5` = official CV (LinkedIn mirror; v8.5 adds the FOX Asset — Infinity Wave contract entry, **LinkedIn paste pending**);
