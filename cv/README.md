...
| File | What it is |
|---|---|
| [`resume-v8.0.txt`](resume-v8.0.txt) | Resume v8.0 — latest resume text (1-page layout). No PDF exported yet; `archive/resume-v7.1.pdf` remains the last distributable PDF. |
| [`linkedin-profile-v2.txt`](linkedin-profile-v2.txt) | LinkedIn profile v2 — copy-paste-ready draft per section (headline, about, experience). Not yet published to LinkedIn. |

## Archive

| File | What it is |
|---|---|
| `archive/resume-v7.1.pdf` | Resume v7.1 — last exported PDF (superseded by v8.0 text). |
...
```
resume:   v7.1 (pdf + txt) ──► v8.0 (txt, current)
...
- New version → add it here, move the superseded file to `archive/`, update this README.
