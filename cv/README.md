...
| Job application / recruiter (1 page, ATS-keyworded) | [`resume-1pager-v1.7.pdf`](resume-1pager-v1.7.pdf) |
...
1pager:      resume-1pager v1.0 ──► v1.1 ──► v1.2 ──► v1.3 ──► v1.4 (ATS keyword expansion) ──► v1.5 (+ FOX Asset entry, Freelance section trimmed) ──► v1.6 (+ expert-advisor-mt-5 PROJECTS line + MQL5 skill) ──► v1.7 (recruiter/ATS edition, v8.2 lineage — parallel artifact, not a mirror; v1.7 = FOX role type → Freelance)
