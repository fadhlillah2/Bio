...
| Job application / recruiter (1 page, ATS-keyworded) | [`resume-onepager-v1.8.pdf`](resume-onepager-v1.8.pdf) |
| Business buyer / consulting lead (EN) | [`consulting-onepager-en-v1.4.pdf`](consulting-onepager-en-v1.4.pdf) |
...
| `archive/resume-onepager-v1.7.txt` / `.pdf` | onepager v1.7 — FOX role type Contract → Freelance. Superseded by v1.8 (Django data-models mislabel fix, em-dash header, URL nowrap guard). |
| `archive/resume-onepager-v1.6.txt` / `.pdf` | onepager v1.6 — + expert-advisor-mt-5 PROJECTS line + MQL5 skill. Superseded by v1.7 (FOX role type Contract → Freelance). |
...
| `archive/resume-onepager-v1.5.txt` / `.pdf` | onepager v1.5 — adds the FOX Asset contract entry; Freelance section folded into Assist.id. Superseded by v1.6 (+ expert-advisor-mt-5 PROJECTS line + MQL5 skill; LMNAS activity line dropped). |
...
| `archive/resume-onepager-v1.4.txt` / `.pdf` | onepager v1.4 — ATS keyword expansion + location precision + alias footer. Superseded by v1.5 (adds the FOX Asset contract entry; trims Freelance section to hold 1 page). |
| `archive/resume-onepager-v1.3.txt` / `.pdf` | onepager v1.3 — superseded by v1.4 (ATS keyword expansion, Danamon "JAKARTA", "Indonesia" contact, alias footer). |
| `archive/consulting-onepager-en-v1.3.txt` / `.pdf` | consulting EN v1.3 — superseded by v1.4 (outcome-led services, 10-vs-17-day differentiator, peak restaurant load). |
...
| `archive/resume-onepager-v1.2.txt` / `.pdf` | onepager v1.2 — superseded by v1.3 (availability → "full-time, remote (international) & consulting"). |
| `archive/consulting-onepager-en-v1.2.txt` / `.pdf` | consulting EN v1.2 — superseded by v1.3 (availability → "full-time, remote (international), and consulting engagements"). |
...
| `archive/resume-v7.1.txt` / `.pdf` | v7.1 — **stale, do not distribute**. |
| `archive/resume-onepager-v1.1.txt` / `.pdf` | onepager v1.1 — superseded by v1.2 (WIB · UTC+7; ATS-hardened header/name rendering). |
| `archive/resume-onepager-v1.0.txt` / `.pdf` | onepager v1.0 — superseded by v1.1 (mentor-5 wording, locations, casing). |
| `archive/consulting-onepager-en-v1.1.txt` / `.pdf` | consulting EN v1.1 — superseded by v1.2 (WIB · UTC+7; page-fill layout). |
| `archive/consulting-onepager-en-v1.0.txt` / `.pdf` | consulting EN v1.0 — superseded by v1.1 (7x → 700%, project name). |
...
- On version bump, also update ALL version-pinned links:
  (a) in-repo `index.html` — 12 `href="cv/…"` in total (`grep -c 'href="cv/' index.html`). Each
  artifact is linked in more than one spot; update every one or the live site 404s:
