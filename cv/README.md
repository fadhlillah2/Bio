...
| Need | Send this |
|---|---|
| Official full CV (LinkedIn mirror, 2 pages) | [`resume-v8.5.pdf`](resume-v8.5.pdf) |
| Job application / recruiter (1 page, ATS-keyworded) | [`resume-1pager-v1.5.pdf`](resume-1pager-v1.5.pdf) |
...
```
resume:      v7.1 ──► v8.0 ──► v8.1 ──► v8.2 (curated 1-page) ──► v8.3 (full LinkedIn mirror, 2 pages) ──► v8.4 (+ expert-advisor-mt-5 block) ──► v8.5 (+ FOX Asset — Infinity Wave contract entry; LinkedIn paste pending)
1pager:      resume-1pager v1.0 ──► v1.1 ──► v1.2 ──► v1.3 ──► v1.4 (ATS keyword expansion) ──► v1.5 (recruiter/ATS edition, v8.2 lineage — parallel artifact, not a mirror; v1.5 = + FOX Asset entry, Freelance section trimmed)
