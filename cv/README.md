...
- On version bump, also update ALL version-pinned links:
  ...
  - `cv/resume-onepager-vX.Y.pdf` (recruiter/ATS 1-pager — bumps on its OWN `v1.x` scheme, not with
    resume-v8.4) — hero **primary** "Download CV" + two Resume-section CTA rows (top + bottom);
  - `cv/consulting-onepager-{en,id}-vX.Y.pdf` — hero buyer line + Services section;
