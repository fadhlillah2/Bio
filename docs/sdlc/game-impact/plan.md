...
Bukti merah: <hash> test/unit.sim.test.mjs
...
- id: G6, kind: kode
- Prasyarat: G5
- Berkas: `src/autotest.js` (skenario final), `tools/harness.mjs`, `tools/serve.mjs`, `tools/smoke.mjs`, `scripts/screenshot.mjs`, `index.html` (wiring mode autotest), `README.md` (cara menjalankan gerbang), `screenshots/gridlock.png` (hasil)
...
Bukti merah: <hash> tools/smoke.mjs
