        ...
        <div class="contact-grid">
          ...
          <div class="contact-channels" data-reveal>
            ...
            <a class="channel" href="mailto:fadhlillah949699@gmail.com">
              ...
              <span class="channel-value">fadhlillah949699@gmail.com</span>
            </a>
            <a class="channel" href="tel:+6285157043131">
              <span class="channel-label">Call</span>
              <span class="channel-value">(+62) 851 5704 3131</span>
            </a>
          ...
          <form action="https://formsubmit.co/fadhlillah949699@gmail.com" method="post" class="contact-form" data-reveal>
            <input type="hidden" name="_next" value="https://fadhlillah2.github.io/Bio/?sent=1#contact">
            ...
            <!-- live regions stay rendered (empty) so role=status/alert announce reliably on text injection -->
