...
<footer class="site-footer">
  <div class="wrap footer-inner">
    ...
    <nav class="footer-links" aria-label="Profiles">
      ...
      <a href="https://leetcode.com/orion_omniscient" target="_blank" rel="noopener">LeetCode <svg class="ico" aria-hidden="true"><use href="#i-arrow-out"/></svg></a>
    ...
    <p class="footer-colophon">
      ...
      <span>Updated <time datetime="2026-09-16">September 2026</time></span>
    </p>
  </div>
</footer>
